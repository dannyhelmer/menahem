...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    limitations: [
      { text: "Political Workspace (organize ongoing research)", excluded: true },
      { text: "Compare multiple documents", excluded: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Political Workspace (organize ongoing research)" },
      { text: "Compare multiple documents" },
