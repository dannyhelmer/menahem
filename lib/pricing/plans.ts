...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    limitations: [
      ...
      { text: "Priority processing", excluded: true },
      { text: "Advanced reasoning models", excluded: true },
    ],
  },
  {
    id: "pro",
    ...
    features: [
      ...
      { text: "Faster AI response speeds" },
      { text: "Priority access during high traffic" },
