...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    ctaHref: "/signup",
    features: [
      { text: "100 AI messages per month" },
      { text: "Basic government research" },
      { text: "Search federal and state legislation" },
      { text: "Search public government documents" },
      { text: "Upload up to 3 documents per day" },
      { text: "Maximum upload size: 10 MB per document" },
    ...
    limitations: [
      ...
      { text: "Research report generation", excluded: true },
      { text: "Export to PDF and DOCX", excluded: true },
      { text: "Unlimited saved conversations", excluded: true },
      { text: "Upload up to 100 documents per month", excluded: true },
      { text: "Maximum upload size: 100 MB per document", excluded: true },
    ],
  },
  {
    id: "pro",
    ...
    features: [
      ...
      { text: "Advanced government research" },
      { text: "Upload up to 100 documents per month" },
      { text: "Maximum upload size: 100 MB per document" },
      { text: "Analyze multiple documents together" },
      { text: "Generate research reports" },
